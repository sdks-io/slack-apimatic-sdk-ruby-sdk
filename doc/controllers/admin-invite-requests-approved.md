...
```ruby
admin_invite_requests_approved_api = client.admin_invite_requests_approved
```
...
result = admin_invite_requests_approved_api.admin_invite_requests_approved_list(token)
