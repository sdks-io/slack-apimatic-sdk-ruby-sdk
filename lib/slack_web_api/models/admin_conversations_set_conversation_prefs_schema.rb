...
module SlackWebApi
  ...
  class AdminConversationsSetConversationPrefsSchema < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      AdminConversationsSetConversationPrefsSchema.new(additional_properties: additional_properties)
    end
