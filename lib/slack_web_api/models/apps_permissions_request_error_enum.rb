...
module SlackWebApi
  ...
  class AppsPermissionsRequestErrorEnum
    APPS_PERMISSIONS_REQUEST_ERROR_ENUM = [
      ...
      # TODO: Write general description for INVALID_USER
    ...
    def self.validate(value)
      ...
      APPS_PERMISSIONS_REQUEST_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = INVALID_TRIGGER)
      ...
      when 'invalid_user' then INVALID_USER
