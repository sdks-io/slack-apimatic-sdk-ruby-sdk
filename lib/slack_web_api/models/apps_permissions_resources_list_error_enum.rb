...
module SlackWebApi
  ...
  class AppsPermissionsResourcesListErrorEnum
    ...
    def self.validate(value)
      ...
      APPS_PERMISSIONS_RESOURCES_LIST_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = INVALID_CURSOR)
