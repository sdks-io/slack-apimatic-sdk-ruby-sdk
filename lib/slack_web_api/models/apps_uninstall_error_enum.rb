...
module SlackWebApi
  ...
  class AppsUninstallErrorEnum
    APPS_UNINSTALL_ERROR_ENUM = [
      # TODO: Write general description for INVALID_CLIENT_ID
      INVALID_CLIENT_ID = 'invalid_client_id'.freeze,

      # TODO: Write general description for BAD_CLIENT_SECRET
      BAD_CLIENT_SECRET = 'bad_client_secret'.freeze,

      # TODO: Write general description for CLIENT_ID_TOKEN_MISMATCH
      CLIENT_ID_TOKEN_MISMATCH = 'client_id_token_mismatch'.freeze,
    ...
    def self.validate(value)
      ...
      APPS_UNINSTALL_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = INVALID_CLIENT_ID)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'invalid_client_id' then INVALID_CLIENT_ID
      when 'bad_client_secret' then BAD_CLIENT_SECRET
      when 'client_id_token_mismatch' then CLIENT_ID_TOKEN_MISMATCH
