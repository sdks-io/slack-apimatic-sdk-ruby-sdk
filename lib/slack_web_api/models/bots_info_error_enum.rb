...
module SlackWebApi
  # BotsInfoErrorEnum.
  class BotsInfoErrorEnum
    BOTS_INFO_ERROR_ENUM = [
      # TODO: Write general description for BOT_NOT_FOUND
      BOT_NOT_FOUND = 'bot_not_found'.freeze,
    ...
    def self.validate(value)
      ...
      BOTS_INFO_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = BOT_NOT_FOUND)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'bot_not_found' then BOT_NOT_FOUND
