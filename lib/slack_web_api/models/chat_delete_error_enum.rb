...
module SlackWebApi
  ...
  class ChatDeleteErrorEnum
    CHAT_DELETE_ERROR_ENUM = [
      ...
      # TODO: Write general description for CANT_DELETE_MESSAGE
      CANT_DELETE_MESSAGE = 'cant_delete_message'.freeze,

      # TODO: Write general description for COMPLIANCE_EXPORTS_PREVENT_DELETION
      COMPLIANCE_EXPORTS_PREVENT_DELETION = 'compliance_exports_prevent_deletion'.freeze,
    ...
    def self.validate(value)
      ...
      CHAT_DELETE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = MESSAGE_NOT_FOUND)
      ...
      when 'cant_delete_message' then CANT_DELETE_MESSAGE
      when 'compliance_exports_prevent_deletion' then COMPLIANCE_EXPORTS_PREVENT_DELETION
