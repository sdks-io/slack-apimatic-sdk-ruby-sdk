...
module SlackWebApi
  # ChatDeleteScheduledMessageErrorEnum.
  class ChatDeleteScheduledMessageErrorEnum
    CHAT_DELETE_SCHEDULED_MESSAGE_ERROR_ENUM = [
      # TODO: Write general description for INVALID_SCHEDULED_MESSAGE_ID
      INVALID_SCHEDULED_MESSAGE_ID = 'invalid_scheduled_message_id'.freeze,

      # TODO: Write general description for CHANNEL_NOT_FOUND
      CHANNEL_NOT_FOUND = 'channel_not_found'.freeze,

      # TODO: Write general description for BAD_TOKEN
      BAD_TOKEN = 'bad_token'.freeze,
    ...
    def self.validate(value)
      ...
      CHAT_DELETE_SCHEDULED_MESSAGE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = INVALID_SCHEDULED_MESSAGE_ID)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'invalid_scheduled_message_id' then INVALID_SCHEDULED_MESSAGE_ID
      when 'channel_not_found' then CHANNEL_NOT_FOUND
      when 'bad_token' then BAD_TOKEN
