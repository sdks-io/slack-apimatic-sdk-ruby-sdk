...
module SlackWebApi
  ...
  class ChatPostEphemeralErrorEnum
    CHAT_POST_EPHEMERAL_ERROR_ENUM = [
      ...
      # TODO: Write general description for USER_NOT_IN_CHANNEL
      USER_NOT_IN_CHANNEL = 'user_not_in_channel'.freeze,
    ...
    def self.validate(value)
      ...
      CHAT_POST_EPHEMERAL_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = CHANNEL_NOT_FOUND)
      ...
      when 'user_not_in_channel' then USER_NOT_IN_CHANNEL
