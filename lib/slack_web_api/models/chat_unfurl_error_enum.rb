...
module SlackWebApi
  # ChatUnfurlErrorEnum.
  class ChatUnfurlErrorEnum
    CHAT_UNFURL_ERROR_ENUM = [
      # TODO: Write general description for CANNOT_UNFURL_URL
      CANNOT_UNFURL_URL = 'cannot_unfurl_url'.freeze,

      # TODO: Write general description for CANNOT_FIND_SERVICE
      CANNOT_FIND_SERVICE = 'cannot_find_service'.freeze,

      # TODO: Write general description for MISSING_UNFURLS
      MISSING_UNFURLS = 'missing_unfurls'.freeze,

      # TODO: Write general description for CANNOT_PROMPT
      CANNOT_PROMPT = 'cannot_prompt'.freeze,
    ...
    def self.validate(value)
      ...
      CHAT_UNFURL_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = CANNOT_UNFURL_URL)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'cannot_unfurl_url' then CANNOT_UNFURL_URL
      when 'cannot_find_service' then CANNOT_FIND_SERVICE
      when 'missing_unfurls' then MISSING_UNFURLS
      when 'cannot_prompt' then CANNOT_PROMPT
