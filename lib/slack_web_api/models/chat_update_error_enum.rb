...
module SlackWebApi
  # ChatUpdateErrorEnum.
  class ChatUpdateErrorEnum
    CHAT_UPDATE_ERROR_ENUM = [
      # TODO: Write general description for MESSAGE_NOT_FOUND
      MESSAGE_NOT_FOUND = 'message_not_found'.freeze,

      # TODO: Write general description for CANT_UPDATE_MESSAGE
      CANT_UPDATE_MESSAGE = 'cant_update_message'.freeze,

      # TODO: Write general description for CHANNEL_NOT_FOUND
      CHANNEL_NOT_FOUND = 'channel_not_found'.freeze,

      # TODO: Write general description for EDIT_WINDOW_CLOSED
      EDIT_WINDOW_CLOSED = 'edit_window_closed'.freeze,
      ...
      # TODO: Write general description for IS_INACTIVE
      IS_INACTIVE = 'is_inactive'.freeze
    ].freeze

    def self.validate(value)
      return false if value.nil?

      CHAT_UPDATE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = MESSAGE_NOT_FOUND)
      ...
      when 'cant_update_message' then CANT_UPDATE_MESSAGE
      when 'channel_not_found' then CHANNEL_NOT_FOUND
      when 'edit_window_closed' then EDIT_WINDOW_CLOSED
      ...
      when 'is_inactive' then IS_INACTIVE
      else
        default_value
      end
    end
