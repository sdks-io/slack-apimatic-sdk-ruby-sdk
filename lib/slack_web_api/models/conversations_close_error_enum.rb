...
module SlackWebApi
  ...
  class ConversationsCloseErrorEnum
    CONVERSATIONS_CLOSE_ERROR_ENUM = [
      ...
      # TODO: Write general description for USER_DOES_NOT_OWN_CHANNEL
      USER_DOES_NOT_OWN_CHANNEL = 'user_does_not_own_channel'.freeze,
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_CLOSE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE)
      ...
      when 'user_does_not_own_channel' then USER_DOES_NOT_OWN_CHANNEL
