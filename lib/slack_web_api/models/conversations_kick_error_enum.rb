...
module SlackWebApi
  ...
  class ConversationsKickErrorEnum
    CONVERSATIONS_KICK_ERROR_ENUM = [
      ...
      # TODO: Write general description for CANT_KICK_SELF
      CANT_KICK_SELF = 'cant_kick_self'.freeze,

      # TODO: Write general description for NOT_IN_CHANNEL
      NOT_IN_CHANNEL = 'not_in_channel'.freeze,

      # TODO: Write general description for CANT_KICK_FROM_GENERAL
      CANT_KICK_FROM_GENERAL = 'cant_kick_from_general'.freeze,
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_KICK_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE)
      ...
      when 'cant_kick_self' then CANT_KICK_SELF
      when 'not_in_channel' then NOT_IN_CHANNEL
      when 'cant_kick_from_general' then CANT_KICK_FROM_GENERAL
