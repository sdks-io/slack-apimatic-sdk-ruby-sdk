...
module SlackWebApi
  # ConversationsLeaveErrorEnum.
  class ConversationsLeaveErrorEnum
    CONVERSATIONS_LEAVE_ERROR_ENUM = [
      ...
      # TODO: Write general description for LAST_MEMBER
      LAST_MEMBER = 'last_member'.freeze,
      ...
      # TODO: Write general description for CANT_LEAVE_GENERAL
      CANT_LEAVE_GENERAL = 'cant_leave_general'.freeze,
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_LEAVE_ERROR_ENUM.include?(value)
    end
