...
module SlackWebApi
  ...
  class ConversationsRenameErrorEnum
    CONVERSATIONS_RENAME_ERROR_ENUM = [
      ...
      # TODO: Write general description for NOT_AUTHORIZED
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_RENAME_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = USER_IS_RESTRICTED)
