...
module SlackWebApi
  ...
  class ConversationsRepliesErrorEnum
    CONVERSATIONS_REPLIES_ERROR_ENUM = [
      ...
      # TODO: Write general description for THREAD_NOT_FOUND
      THREAD_NOT_FOUND = 'thread_not_found'.freeze,
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_REPLIES_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = MISSING_SCOPE)
      ...
      when 'thread_not_found' then THREAD_NOT_FOUND
