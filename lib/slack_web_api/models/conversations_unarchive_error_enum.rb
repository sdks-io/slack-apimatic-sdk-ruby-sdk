...
module SlackWebApi
  # ConversationsUnarchiveErrorEnum.
  class ConversationsUnarchiveErrorEnum
    CONVERSATIONS_UNARCHIVE_ERROR_ENUM = [
      ...
      # TODO: Write general description for NOT_ARCHIVED
      NOT_ARCHIVED = 'not_archived'.freeze,
    ...
    def self.validate(value)
      ...
      CONVERSATIONS_UNARCHIVE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE)
      ...
      when 'not_archived' then NOT_ARCHIVED
