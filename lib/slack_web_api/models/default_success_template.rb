...
module SlackWebApi
  # This method either only returns a brief _OK_ response or a verbose schema is
  # not available for this method.
  class DefaultSuccessTemplate < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DefaultSuccessTemplate.new(additional_properties: additional_properties)
    end
