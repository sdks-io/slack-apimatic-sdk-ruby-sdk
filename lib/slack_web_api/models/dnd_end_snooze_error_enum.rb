...
module SlackWebApi
  # DndEndSnoozeErrorEnum.
  class DndEndSnoozeErrorEnum
    DND_END_SNOOZE_ERROR_ENUM = [
      # TODO: Write general description for SNOOZE_NOT_ACTIVE
      SNOOZE_NOT_ACTIVE = 'snooze_not_active'.freeze,

      # TODO: Write general description for SNOOZE_END_FAILED
      SNOOZE_END_FAILED = 'snooze_end_failed'.freeze,
    ...
    def self.validate(value)
      ...
      DND_END_SNOOZE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = SNOOZE_NOT_ACTIVE)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'snooze_not_active' then SNOOZE_NOT_ACTIVE
      when 'snooze_end_failed' then SNOOZE_END_FAILED
