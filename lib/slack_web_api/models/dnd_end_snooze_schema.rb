...
module SlackWebApi
  ...
  class DndEndSnoozeSchema < BaseModel
    SKIP = Object.new
    ...
    def initialize(dnd_enabled:, next_dnd_end_ts:, next_dnd_start_ts:,
                   snooze_enabled:, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      DndEndSnoozeSchema.new(dnd_enabled: dnd_enabled,
                             next_dnd_end_ts: next_dnd_end_ts,
                             next_dnd_start_ts: next_dnd_start_ts,
                             snooze_enabled: snooze_enabled,
                             additional_properties: additional_properties)
    ...
    def inspect
      ...
      " #{@ok.inspect}, snooze_enabled: #{@snooze_enabled.inspect}, additional_properties:"\
