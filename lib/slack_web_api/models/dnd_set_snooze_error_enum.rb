...
module SlackWebApi
  # DndSetSnoozeErrorEnum.
  class DndSetSnoozeErrorEnum
    DND_SET_SNOOZE_ERROR_ENUM = [
      # TODO: Write general description for MISSING_DURATION
      MISSING_DURATION = 'missing_duration'.freeze,

      # TODO: Write general description for SNOOZE_FAILED
      SNOOZE_FAILED = 'snooze_failed'.freeze,
    ...
    def self.validate(value)
      ...
      DND_SET_SNOOZE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = MISSING_DURATION)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'missing_duration' then MISSING_DURATION
      when 'snooze_failed' then SNOOZE_FAILED
