...
module SlackWebApi
  ...
  class FilesCommentsDeleteErrorEnum
    FILES_COMMENTS_DELETE_ERROR_ENUM = [
      # TODO: Write general description for CANT_DELETE
      CANT_DELETE = 'cant_delete'.freeze,

      # TODO: Write general description for COMMENT_NOT_FOUND
      COMMENT_NOT_FOUND = 'comment_not_found'.freeze,
    ...
    def self.validate(value)
      ...
      FILES_COMMENTS_DELETE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = CANT_DELETE)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'cant_delete' then CANT_DELETE
      when 'comment_not_found' then COMMENT_NOT_FOUND
