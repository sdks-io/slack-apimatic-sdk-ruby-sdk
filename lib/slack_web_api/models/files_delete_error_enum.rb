...
module SlackWebApi
  # FilesDeleteErrorEnum.
  class FilesDeleteErrorEnum
    FILES_DELETE_ERROR_ENUM = [
      ...
      # TODO: Write general description for CANT_DELETE_FILE
      CANT_DELETE_FILE = 'cant_delete_file'.freeze,
    ...
    def self.validate(value)
      ...
      FILES_DELETE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = FILE_NOT_FOUND)
      ...
      when 'cant_delete_file' then CANT_DELETE_FILE
