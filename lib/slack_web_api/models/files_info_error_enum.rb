...
module SlackWebApi
  # FilesInfoErrorEnum.
  class FilesInfoErrorEnum
    FILES_INFO_ERROR_ENUM = [
      # TODO: Write general description for FILE_NOT_FOUND
      FILE_NOT_FOUND = 'file_not_found'.freeze,

      # TODO: Write general description for FILE_DELETED
      FILE_DELETED = 'file_deleted'.freeze,

      # TODO: Write general description for TIMEZONE_COUNT_FAILED
      TIMEZONE_COUNT_FAILED = 'timezone_count_failed'.freeze,
    ...
    def self.validate(value)
      ...
      FILES_INFO_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = FILE_NOT_FOUND)
      ...
      when 'file_deleted' then FILE_DELETED
      when 'timezone_count_failed' then TIMEZONE_COUNT_FAILED
