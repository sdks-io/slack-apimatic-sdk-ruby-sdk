...
module SlackWebApi
  ...
  class FilesListErrorEnum
    ...
    def self.validate(value)
      ...
      FILES_LIST_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = USER_NOT_FOUND)
      ...
      when 'unknown_type' then UNKNOWN_TYPE
