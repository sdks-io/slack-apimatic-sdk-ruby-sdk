...
module SlackWebApi
  ...
  class MigrationExchangeErrorEnum
    MIGRATION_EXCHANGE_ERROR_ENUM = [
      # TODO: Write general description for NOT_ENTERPRISE_TEAM
      NOT_ENTERPRISE_TEAM = 'not_enterprise_team'.freeze,
    ...
    def self.validate(value)
      ...
      MIGRATION_EXCHANGE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = NOT_ENTERPRISE_TEAM)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'not_enterprise_team' then NOT_ENTERPRISE_TEAM
