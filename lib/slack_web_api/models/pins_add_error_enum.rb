...
module SlackWebApi
  ...
  class PinsAddErrorEnum
    PINS_ADD_ERROR_ENUM = [
      ...
      # TODO: Write general description for ALREADY_PINNED
      ALREADY_PINNED = 'already_pinned'.freeze,

      # TODO: Write general description for PERMISSION_DENIED
      PERMISSION_DENIED = 'permission_denied'.freeze,

      # TODO: Write general description for FILE_NOT_SHARED
      FILE_NOT_SHARED = 'file_not_shared'.freeze,

      # TODO: Write general description for NOT_PINNABLE
      NOT_PINNABLE = 'not_pinnable'.freeze,
    ...
    def self.validate(value)
      ...
      PINS_ADD_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = BAD_TIMESTAMP)
      ...
      when 'already_pinned' then ALREADY_PINNED
      when 'permission_denied' then PERMISSION_DENIED
      when 'file_not_shared' then FILE_NOT_SHARED
      when 'not_pinnable' then NOT_PINNABLE
