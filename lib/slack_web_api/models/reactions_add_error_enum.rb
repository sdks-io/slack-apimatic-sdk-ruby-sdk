...
module SlackWebApi
  # ReactionsAddErrorEnum.
  class ReactionsAddErrorEnum
    REACTIONS_ADD_ERROR_ENUM = [
      ...
      # TODO: Write general description for ALREADY_REACTED
      ALREADY_REACTED = 'already_reacted'.freeze,

      # TODO: Write general description for TOO_MANY_EMOJI
      TOO_MANY_EMOJI = 'too_many_emoji'.freeze,

      # TODO: Write general description for TOO_MANY_REACTIONS
      TOO_MANY_REACTIONS = 'too_many_reactions'.freeze,
    ...
    def self.validate(value)
      ...
      REACTIONS_ADD_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = BAD_TIMESTAMP)
      ...
      when 'already_reacted' then ALREADY_REACTED
      when 'too_many_emoji' then TOO_MANY_EMOJI
      when 'too_many_reactions' then TOO_MANY_REACTIONS
