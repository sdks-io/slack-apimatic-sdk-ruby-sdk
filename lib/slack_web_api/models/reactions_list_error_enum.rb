...
module SlackWebApi
  ...
  class ReactionsListErrorEnum
    REACTIONS_LIST_ERROR_ENUM = [
      ...
      # TODO: Write general description for ACCOUNT_INACTIV
      ACCOUNT_INACTIV = 'account_inactiv'.freeze,
    ...
    def self.validate(value)
      ...
      REACTIONS_LIST_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = USER_NOT_FOUND)
      ...
      when 'account_inactiv' then ACCOUNT_INACTIV
