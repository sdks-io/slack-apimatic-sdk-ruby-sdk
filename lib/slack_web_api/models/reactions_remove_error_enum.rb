...
module SlackWebApi
  # ReactionsRemoveErrorEnum.
  class ReactionsRemoveErrorEnum
    REACTIONS_REMOVE_ERROR_ENUM = [
      ...
      # TODO: Write general description for NO_REACTION
      NO_REACTION = 'no_reaction'.freeze,
    ...
    def self.validate(value)
      ...
      REACTIONS_REMOVE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = BAD_TIMESTAMP)
      ...
      when 'no_reaction' then NO_REACTION
