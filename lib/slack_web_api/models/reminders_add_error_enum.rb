...
module SlackWebApi
  # RemindersAddErrorEnum.
  class RemindersAddErrorEnum
    REMINDERS_ADD_ERROR_ENUM = [
      # TODO: Write general description for CANNOT_PARSE
      CANNOT_PARSE = 'cannot_parse'.freeze,

      # TODO: Write general description for USER_NOT_FOUND
      USER_NOT_FOUND = 'user_not_found'.freeze,

      # TODO: Write general description for CANNOT_ADD_BOT
      CANNOT_ADD_BOT = 'cannot_add_bot'.freeze,

      # TODO: Write general description for CANNOT_ADD_SLACKBOT
      CANNOT_ADD_SLACKBOT = 'cannot_add_slackbot'.freeze,

      # TODO: Write general description for CANNOT_ADD_OTHERS
      CANNOT_ADD_OTHERS = 'cannot_add_others'.freeze,

      # TODO: Write general description for CANNOT_ADD_OTHERS_RECURRING
      CANNOT_ADD_OTHERS_RECURRING = 'cannot_add_others_recurring'.freeze,
    ...
    def self.validate(value)
      ...
      REMINDERS_ADD_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = CANNOT_PARSE)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'cannot_parse' then CANNOT_PARSE
      when 'user_not_found' then USER_NOT_FOUND
      when 'cannot_add_bot' then CANNOT_ADD_BOT
      when 'cannot_add_slackbot' then CANNOT_ADD_SLACKBOT
      when 'cannot_add_others' then CANNOT_ADD_OTHERS
      when 'cannot_add_others_recurring' then CANNOT_ADD_OTHERS_RECURRING
