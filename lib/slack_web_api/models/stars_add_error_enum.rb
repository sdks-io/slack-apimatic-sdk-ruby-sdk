...
module SlackWebApi
  ...
  class StarsAddErrorEnum
    STARS_ADD_ERROR_ENUM = [
      ...
      # TODO: Write general description for ALREADY_STARRED
      ALREADY_STARRED = 'already_starred'.freeze,
    ...
    def self.validate(value)
      ...
      STARS_ADD_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = BAD_TIMESTAMP)
      ...
      when 'already_starred' then ALREADY_STARRED
