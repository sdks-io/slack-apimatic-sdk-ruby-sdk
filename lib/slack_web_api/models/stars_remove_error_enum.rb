...
module SlackWebApi
  # StarsRemoveErrorEnum.
  class StarsRemoveErrorEnum
    STARS_REMOVE_ERROR_ENUM = [
      ...
      # TODO: Write general description for NOT_STARRED
      NOT_STARRED = 'not_starred'.freeze,
    ...
    def self.validate(value)
      ...
      STARS_REMOVE_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = BAD_TIMESTAMP)
      ...
      when 'not_starred' then NOT_STARRED
