...
module SlackWebApi
  ...
  class UsersConversationsErrorEnum
    USERS_CONVERSATIONS_ERROR_ENUM = [
      ...
      # TODO: Write general description for INVALID_TYPES
      INVALID_TYPES = 'invalid_types'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_CONVERSATIONS_ERROR_ENUM.include?(value)
    end
    ...
    def self.from_value(value, default_value = METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE)
      ...
      when 'invalid_types' then INVALID_TYPES
