...
module SlackWebApi
  # UsersListErrorEnum.
  class UsersListErrorEnum
    USERS_LIST_ERROR_ENUM = [
      # TODO: Write general description for LIMIT_REQUIRED
      LIMIT_REQUIRED = 'limit_required'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_LIST_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = LIMIT_REQUIRED)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'limit_required' then LIMIT_REQUIRED
