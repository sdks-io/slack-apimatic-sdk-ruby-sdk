...
module SlackWebApi
  ...
  class UsersLookupByEmailErrorEnum
    USERS_LOOKUP_BY_EMAIL_ERROR_ENUM = [
      # TODO: Write general description for USERS_NOT_FOUND
      USERS_NOT_FOUND = 'users_not_found'.freeze,

      # TODO: Write general description for ENTERPRISE_IS_RESTRICTED
      ENTERPRISE_IS_RESTRICTED = 'enterprise_is_restricted'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_LOOKUP_BY_EMAIL_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = USERS_NOT_FOUND)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'users_not_found' then USERS_NOT_FOUND
      when 'enterprise_is_restricted' then ENTERPRISE_IS_RESTRICTED
