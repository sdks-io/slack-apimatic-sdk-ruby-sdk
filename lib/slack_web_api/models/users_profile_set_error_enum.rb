...
module SlackWebApi
  # UsersProfileSetErrorEnum.
  class UsersProfileSetErrorEnum
    USERS_PROFILE_SET_ERROR_ENUM = [
      # TODO: Write general description for RESERVED_NAME
      RESERVED_NAME = 'reserved_name'.freeze,

      # TODO: Write general description for INVALID_PROFILE
      INVALID_PROFILE = 'invalid_profile'.freeze,

      # TODO: Write general description for PROFILE_SET_FAILED
      PROFILE_SET_FAILED = 'profile_set_failed'.freeze,

      # TODO: Write general description for NOT_ADMIN
      NOT_ADMIN = 'not_admin'.freeze,

      # TODO: Write general description for NOT_APP_ADMIN
      NOT_APP_ADMIN = 'not_app_admin'.freeze,

      # TODO: Write general description for CANNOT_UPDATE_ADMIN_USER
      CANNOT_UPDATE_ADMIN_USER = 'cannot_update_admin_user'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_PROFILE_SET_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = RESERVED_NAME)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'reserved_name' then RESERVED_NAME
      when 'invalid_profile' then INVALID_PROFILE
      when 'profile_set_failed' then PROFILE_SET_FAILED
      when 'not_admin' then NOT_ADMIN
      when 'not_app_admin' then NOT_APP_ADMIN
      when 'cannot_update_admin_user' then CANNOT_UPDATE_ADMIN_USER
