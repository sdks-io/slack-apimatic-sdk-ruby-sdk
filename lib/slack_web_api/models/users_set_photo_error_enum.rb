...
module SlackWebApi
  # UsersSetPhotoErrorEnum.
  class UsersSetPhotoErrorEnum
    USERS_SET_PHOTO_ERROR_ENUM = [
      # TODO: Write general description for BAD_IMAGE
      BAD_IMAGE = 'bad_image'.freeze,

      # TODO: Write general description for TOO_LARGE
      TOO_LARGE = 'too_large'.freeze,

      # TODO: Write general description for TOO_MANY_FRAMES
      TOO_MANY_FRAMES = 'too_many_frames'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_SET_PHOTO_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = BAD_IMAGE)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'bad_image' then BAD_IMAGE
      when 'too_large' then TOO_LARGE
      when 'too_many_frames' then TOO_MANY_FRAMES
