...
module SlackWebApi
  # UsersSetPresenceErrorEnum.
  class UsersSetPresenceErrorEnum
    USERS_SET_PRESENCE_ERROR_ENUM = [
      # TODO: Write general description for INVALID_PRESENCE
      INVALID_PRESENCE = 'invalid_presence'.freeze,
    ...
    def self.validate(value)
      ...
      USERS_SET_PRESENCE_ERROR_ENUM.include?(value)
    end

    def self.from_value(value, default_value = INVALID_PRESENCE)
      return default_value if value.nil?

      str = value.to_s.strip

      case str.downcase
      when 'invalid_presence' then INVALID_PRESENCE
